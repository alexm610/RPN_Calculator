...
; This file was generated Tue Dec 06 22:55:25 2022
;--------------------------------------------------------
$name blinky
$optc51 --model-small
	R_DSEG    segment data
...
;------------------------------------------------------------
;	blinky.c:5: void mydelay (void)
;	-----------------------------------------
;	 function mydelay
;	-----------------------------------------
_mydelay:
;	blinky.c:8: for(j=0; j<500000; j++);
	mov	r2,#0x20
	mov	r3,#0xA1
	mov	r4,#0x07
	mov	r5,#0x00
L020003?:
	dec	r2
	cjne	r2,#0xff,L020009?
	dec	r3
	cjne	r3,#0xff,L020009?
	dec	r4
	cjne	r4,#0xff,L020009?
	dec	r5
L020009?:
	mov	a,r2
	orl	a,r3
...
;	blinky.c:16: mydelay();
	lcall	_mydelay
;	blinky.c:17: printf("Hello from blinky!\n");
	mov	a,#__str_0
	push	acc
	mov	a,#(__str_0 >> 8)
	push	acc
